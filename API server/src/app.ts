...
import logger from '../server-core/src/logger'
import channels from './channels'
import authentication from '../server-core/src/user/authentication'
import config from '../server-core/src/appconfig'
import sync from 'feathers-sync'
import { api } from '../server-core/src/k8s'
import winston from 'winston'
import feathersLogger from 'feathers-logger'
import { EventEmitter } from 'events'
import services from '../server-core/src/services'
import sequelize from '../server-core/src/sequelize'
