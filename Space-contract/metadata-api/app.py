...
FIRST_NAMES = ['Clifford', 'Curton', 'Seamas', 'Jadark', 'Randy', 'Captain']
LAST_NAMES = ['Nonson', 'Brewer', 'Warley', 'Kelsonian', 'Martinez', 'Gursor']

BASES = ['rocinante', 'daedalus', 'explorer', 'excalibur', 'intrepid', 'odyssey']
...
CONTRACT_URI_METADATA = {
    ...
    'opensea-erc1155': {
        'name': 'Space Ship Accessories',
        'description': "Fun and useful accessories for your Space Ship.",
        'image': 'https://example.com/image.png',
...
def creature(token_id):
    ...
    return jsonify({
        'name': creature_name,
        'description': 'Friendly Space Ship that enjoys long swims in the space.',
        'image': image_url,
...
def creature_box(token_id):
    ...
    return jsonify({
        ...
        'description': 'This lootbox contains some Space Ship! It can also be traded!',
        'image': image_url,
        'external_url': 'https://openseacreatures.io/%s' % token_id,
        'attributes': attributes
    })
...
def accessory(token_id):
    ...
    return jsonify({
        'name': accessory_name,
        'description': 'A fun and useful accessory for your friendly Space Ship.',
        'image': image_url,
...
def accessory_box(token_id):
    ...
    return jsonify({
        ...
        'description': 'This lootbox contains some Space Ship accessories! It can also be traded!',
        'image': image_url,
...
def accessory_factory(token_id):
    token_id = int(token_id)
    if token_id == 0:
        name = 'One Space Ship accessory'
        description = 'When you purchase this option, you will receive a single Space Ship accessory of a random variety. ' \
                      'Enjoy and take good care of your aquatic being!'
        image_url = _compose_image(['images/factory/egg.png'], token_id, 'factory')
        num_inside = 1
    elif token_id == 1:
        name = 'Four Space Ship accessories'
        description = 'When you purchase this option, you will receive four Space Ship accessories of random variety. ' \
                      'Enjoy and take good care of your aquatic beings!'
        image_url = _compose_image(['images/factory/four-eggs.png'], token_id, 'factory')
        num_inside = 4
    elif token_id == 2:
        name = 'One Space Ship accessory lootbox'
        description = 'When you purchase this option, you will receive one lootbox, which can be opened to reveal three ' \
                      'Space Ship accessories of random variety. Enjoy and take good care of these cute aquatic beings!'
        image_url = _compose_image(['images/box/lootbox.png'], token_id, 'factory')
        num_inside = 3
